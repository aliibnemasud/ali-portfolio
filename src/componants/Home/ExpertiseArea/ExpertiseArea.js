            ...
            <div className='container'>
                ...
                <div className='d-flex flex-wrap justify-content-between'>
                    ...
                    <div className='owncard p-4'>
                        <div className=''>
                            <img className='img-fluid mx-auto d-block w-50' src={Webdevelopment} alt="" />
                        </div>
                    ...
                    <div className='owncard p-4'>
                        <div className=''>
                            <img className='img-fluid mx-auto d-block w-50' src={Uiux} alt="" />
                        </div>
                    ...
                    <div className='owncard p-4'>
                        <div className=''>
                            <img className='img-fluid mx-auto d-block w-50' src={rreact} alt="" />
                        </div>
